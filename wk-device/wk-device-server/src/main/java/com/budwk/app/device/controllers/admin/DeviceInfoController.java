...
public class DeviceInfoController {
    ...
    public Result<?> list(@Param("pageNo") int pageNo, @Param("pageSize") int pageSize, @Param("pageOrderName") String pageOrderName, @Param("pageOrderBy") String pageOrderBy) {
        return Result.data(deviceInfoService.listPage(pageNo, pageSize, Cnd.NEW().asc("location")));
    }

    @At
    @Ok("json")
    @POST
    @ApiOperation(name = "新增Device_info")
    @ApiFormParams(
            implementation = Device_info.class
    )
    @ApiResponses
    @SLog("新增Device_info:${deviceInfo.id}")
    @SaCheckPermission("device.info.create")
    ...
    @Ok("json")
    @POST
    @ApiOperation(name = "修改Device_info")
    @ApiFormParams(
            implementation = Device_info.class
    )
    @ApiResponses
    ...
    @Ok("json")
    @GET
    @ApiOperation(name = "获取Device_info")
    @ApiImplicitParams(
            {
