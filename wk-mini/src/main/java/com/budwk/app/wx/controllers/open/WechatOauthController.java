...
public class WechatOauthController {
    ...
    @Ok("re")
    @Filters
    public String oauth(String wxid, @Param(value = "goto_url", df = "/wechat/open/cms/channel") String goto_url, HttpServletRequest req, HttpSession session) throws Exception {
